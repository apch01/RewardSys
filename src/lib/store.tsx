...
type StoreContextValue = {
  ...
  addReward: (input: Pick<Reward, "title" | "cost" | "description" | "redeemMode">) => Promise<void>;
  updateReward: (id: string, updates: Pick<Reward, "title" | "cost" | "description" | "redeemMode">) => Promise<void>;
